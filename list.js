          ...
          if (data[i].completed == true) {
            ...
            &emsp;<span class="datalistComp">
              <s style="color: rgb(214, 106, 106)" >
                <small style="color: #dcdcde">${data[i].title}
                </small>
              </s>
            </span><br><hr>`;
            completed++;
            ...
            &emsp;<span class="datalist">
                <span style="color: white">${data[i].title}
                </span>
            </span><br><hr>`;
          }
    ...
    for (var i = 0; i < chbox.length; i++) {
      if (chbox[i].checked) {
        dataTitle[i].innerHTML = `
                <span class = "strike"><small style = "color: #dcdcde" >${dataTitle[i].textContent}
                </small></span>
                `;
      } else {
        dataTitle[
          i
        ].innerHTML = `<span style="color: white">${dataTitle[i].textContent}</span>`;
      }
    }
  }
